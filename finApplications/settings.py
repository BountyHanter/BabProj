"""
Django settings for finApplications project.
...
#ALLOWED_HOSTS = ["dev.babdata.cloud", "127.0.0.1", "localhost", "193.124.47.164"]
ALLOWED_HOSTS = ["*"]
...
ROOT_URLCONF = 'finApplications.urls'
...
WSGI_APPLICATION = 'finApplications.wsgi.application'
